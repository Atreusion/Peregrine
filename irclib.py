...
##    def servernick(self, newnick, ident, host, server, modes, message):
##        """Send a NICK command."""
##        self.send_raw("NICK " + newnick + " 1 0 " + ident + " " + host + " " + server + " 0 " + modes + " :" + message)
##
##    def serverpass(self, password):
##        """Send a PASS command."""
##        self.send_raw("PASS = :" + password)
##
##    def serverserver(self, name, message):
##        """Send a SERVER command."""
##        self.send_raw("SERVER " + name + " 1 :" + message)
